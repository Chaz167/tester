...
# I hate this regex so much. Anyway, what it does is match everything in the
# function definition of `newPhotographLog`, including the name, parens and
# opening curly brace, but excluding the closing curly brace. This allows us to
# stick a line right before the closing curly brace.
